...
- 생성 시각(KST): **2026-03-19 17:04:45**
- 최근 데이터 기준 Lookback: **365일**

## 수집 시점 기준 - 시간별 스냅샷

- 합계: **500,379**, 마지막: **1,203**, 피크: **7,202**

![수집 시점 기준 - 시간별 스냅샷](charts/snapshots_hourly.png)

## 수집 시점 기준 - 일별 스냅샷

- 합계: **500,379**, 마지막: **14,406**, 피크: **50,285**

![수집 시점 기준 - 일별 스냅샷](charts/snapshots_daily.png)

## 수집 시점 기준 - 월별 스냅샷

- 합계: **500,379**, 마지막: **485,978**, 피크: **485,978**

![수집 시점 기준 - 월별 스냅샷](charts/snapshots_monthly.png)

## 수집 시점 기준 - 연별 스냅샷

- 합계: **500,379**, 마지막: **500,379**, 피크: **500,379**
