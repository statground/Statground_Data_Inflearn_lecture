...
- This repo writes stats artifacts to `reports/inflearn/` and commits them via GitHub Actions.
- `reports/inflearn/inflearn_stats_latest.md` is the latest snapshot.
- `reports/inflearn/inflearn_stats_YYYYMMDD_HH.md` keeps hourly history.
- Charts are stored under `reports/inflearn/charts/`.
